...
/**
 * This is a Sample topology for storm where we consume a stream of words and executes an append
 * operation to them.
 */
public final class ExclamationTopology {
  ...
  public static void main(String[] args) throws Exception {
    ...
    builder.setBolt("exclaim", new ExclamationBolt(), 2 * parallelism).shuffleGrouping("word");
  ...
  /**
   * ExclamationBolt Bolt that takes a string word as outputs the same word with exclamation marks
   * appended
   */
  static class ExclamationBolt extends BaseRichBolt {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
      declarer.declare(
          new Fields("modified_word")); // Here we tagethe output tuple with the tag "modified_word"
    }
  }
}
